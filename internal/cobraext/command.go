...
// CommandContext is the context in which an elastic-agent-changelog command runs.
...
// to elastic-agent-changelog commands.
type Command struct {
	*cobra.Command
...
// Name returns the name of the elastic-agent-changelog command.
func (c *Command) Name() string {
	return c.Command.Use
}

// Short returns a short description for the elastic-agent-changelog command.
func (c *Command) Short() string {
	return c.Command.Short
}

// Long returns a long description for the elastic-agent-changelog command.
func (c *Command) Long() string {
	return c.longDesc
}

// Context returns the context for the elastic-agent-changelog command.
